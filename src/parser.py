...
class CodeGenerator:
    ...
    def _generate_functions(self):
        ...
        transforms = {
            ...
            'replace': 'return str(value).replace(str(args[0]), str(args[1])) if len(args) > 1 else value',
            ...
            'round': 'return round(float(value), int(args[0])) if args else round(float(value))',
